...
module.exports.consolidador_pedidos = (req, res) => {
    const { dateFrom, dateTo, contratista, sector, servicio, pdi } = req.query;
    var connection = mysql.createConnection(credenciales);
...
module.exports.consolidador_logistica = (req, res) => {
    const { dateFrom, dateTo } = req.query; // Obtén los parámetros de fecha desde la query
