...
module.exports.pedidos = (req, res) =>{
...
module.exports.pedidos_detalle = (req, res) => {
    var connection = mysql.createConnection(credenciales);
    connection.query(
        `SELECT 
            pedidos_detalle.*, 
...
module.exports.pedidos_detalle_id = (req, res) => {
...
module.exports.pedidosBySector = (req, res) => {
...
module.exports.pedidosByUser = (req, res) => {
...
module.exports.pedidosByLiquidador = (req, res) => {
